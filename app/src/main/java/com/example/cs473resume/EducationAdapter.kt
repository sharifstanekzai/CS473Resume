...
class EducationAdapter(private val context: Activity,private val arrayList:ArrayList<EducationModel>):
ArrayAdapter<EducationModel>(context,R.layout.list_item,arrayList)
{
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        summary.text = arrayList[position].location
